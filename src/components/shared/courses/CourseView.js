    ...
    return (
      ...
      >  { console.log(course)}
            ...
            <div className="mt-4">
                ...
                <p className="text-gray-600 text-sm uppercase">By {course.instructor}</p>
            ...
            <button 
                    className="mt-4 w-full bg-pink-300 text-white font-semibold py-2 rounded-lg hover:bg-blue-700 transition duration-300"
                    onClick={() => router.push(`./user-enrolled-courses/${course.id}`)}
                >
                    Learn 📖
                </button>
